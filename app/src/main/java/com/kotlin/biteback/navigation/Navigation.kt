...
import com.kotlin.biteback.ui.userProfile.UserProfileViewModelFactory
...
import com.kotlin.biteback.ui.userProfile.UserProfile
import com.kotlin.biteback.ui.userProfile.UserProfileViewModel
...
fun AppNavigation(context: Context, startDestination: String) {
    ...
    NavHost(navController = navController, startDestination = startDestination) {
        ...
        composable("profile") {
            UserProfile(navController = navController, currentRoute = currentRoute)
        }
        composable("mystery") {
